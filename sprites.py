...
class PlayerSprite(Spritesheet):
    ...
    def defineAnimations(self):
        self.animations[LEFT] = Animator(((130, 64), (195, 64), (260, 64), (325, 64), (390, 64), (455, 64), (520, 64), (585, 64)), speed=10, loop=False)
        self.animations[RIGHT] = Animator(((60, 0), (125, 0), (190, 0), (255, 0), (320, 0), (385, 0), (450, 0), (515, 0), (580, 0)), speed=10, loop=False)
